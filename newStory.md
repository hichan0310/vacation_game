...
입 밖으로 나오는 순간, 그 말은 너무 가볍게 들렸다.  
그러나 내 마음 깊은 곳에서, 그 문장은 금이 간 벽처럼 갈라졌다.  
지켜야 할 것이 사라졌다는 자각.  
...
마지막 히든보스를 격파한 이후 그 방에서 떨어지면서 엔딩을 본다.  
그리고 처음 그렇게 엔딩을 보면 에일라가 나타나서 플레이어가 엘라리아의 능력으로 치트를 쓸 수도 있지만, 그렇게 되면 적이 강해질 것이라고 한다.  
